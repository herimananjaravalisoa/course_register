package course.poja.demo.handler;

import static course.poja.demo.concurrency.ThreadRenamer.renameWorkerThread;
...
import course.poja.demo.PojaApplication;
import course.poja.demo.PojaGenerated;
import course.poja.demo.endpoint.EndpointConf;
import course.poja.demo.endpoint.event.EventConf;
import course.poja.demo.endpoint.event.consumer.EventConsumer;
import course.poja.demo.endpoint.event.consumer.model.ConsumableEvent;
import course.poja.demo.endpoint.event.consumer.model.ConsumableEventTyper;
