package course.poja.demo.endpoint.event.consumer;

import course.poja.demo.PojaGenerated;
import course.poja.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("course.poja.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "course.poja.demo.service.event."
