package course.poja.demo.endpoint.event.model;

import static course.poja.demo.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import course.poja.demo.PojaGenerated;
import course.poja.demo.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "course.poja.demo.event1";
  }
}
